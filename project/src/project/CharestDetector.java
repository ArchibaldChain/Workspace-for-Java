...
/**
 * @author 閮戞槑浜�
 * @Time锛�2016骞�10鏈�28鏃� 涓嬪崍5:58:24
 * @version 1.0
 */
/**
 * <Detect encoding .>
 ...
 * @version 1.0
 */
public class CharestDetector {
    /**
     * @param path give the file path
     * @return the file
     */
    public static String CharDetect(String path) {
        if(path == null || path == ""){
            return "utf-8";
        }
    ...
    public static void main(String[] args) {
        String file = "testText/test2_Default.txt";//todo
    ...
    public static void readFile(String file, String code) {
        ...
        try {
            ...
            String line = null;
            int flag=1;
            // 璇诲彇姣忎竴琛岋紝濡傛灉缁撴潫浜嗭紝line浼氫负绌�
            while ((line = fr.readLine()) != null && line.trim().length() > 0) {
                if(flag==1) {
                    line=line.substring(1);//鍘绘帀鏂囦欢澶�
                    flag++;
                }
                // 姣忎竴琛屽垱寤轰竴涓猄tudent瀵硅薄锛屽苟瀛樺叆鏁扮粍涓�
